...
var GRAPHQL_SCHEMA_PATH = path.resolve(
...
var NappJSGraphqlAPI = (function(_super) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            app.post(
              GRAPHQL_API_PATH,
              apollo_server_express_1.graphqlExpress(function(req) {
                return { schema: schema, context: req, tracing: true };
              })
            );
            app.get(
              GRAPHQL_API_PATH,
              graphql_playground_middleware_express_1.default({
                endpoint: GRAPHIQL_API_PATH || GRAPHQL_API_PATH
              })
            );
            return [2];
        }
        ...
        switch (_d.label) {
          case 0:
            if (!fs.existsSync(GRAPHQL_SCHEMA_PATH)) {
              console.log(
                'folder with graphql schemas not found (path: ' +
                  GRAPHQL_SCHEMA_PATH +
                  ')'
              );
              return [2];
  ...
  NappJSGraphqlAPI.prototype.getSchemaFromFiles = function(
    schemaPath,
    scriptPath
  ) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            fetcher = apollo_fetch_nappjs_1.createApolloFetch({
              uri: resolvers
            });
          ...
          case 3:
            return [
              2,
              _a.apply(void 0, [((_b.schema = _c), (_b.fetcher = fetcher), _b)])
            ];
          case 4:
